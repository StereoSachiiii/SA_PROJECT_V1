...
// import { useState } from 'react'; used for the hover state of the profile dropdown, but decided to go with pure CSS hover instead for simplicity and better responsiveness
                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex items-center gap-10">
                        ...
                        <div className="hidden md:flex items-center space-x-2">
                            ...
                            <Link to="/stalls" className={`px-5 py-2.5 text-base ${isActive('/stalls')}`}>
                                Stalls
                            </Link>
                        </div>
                    </div>
                        ...
                        {user ? (
                            <div className="flex items-center gap-4 pl-6 border-l border-gray-100">
                                ...
                                <div className="hidden sm:flex items-center gap-3 bg-gray-50 px-4 py-2 rounded-full border border-gray-100 shadow-sm relative group cursor-pointer group-hover:bg-white transition-all">
                                        ...
                                        <div className="absolute top-full right-0 mt-2 bg-white border border-slate-100 shadow-xl rounded-2xl p-2 hidden group-hover:block z-50 min-w-[160px]">
                                            {user.role === 'VENDOR' && (
