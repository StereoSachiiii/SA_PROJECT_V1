...
function ReservationTicket({ reservation }: ReservationTicketProps) {
    ...
    return (
        <>
            {/* Ticket */}
            <div
                onClick={() => !isDeleting && setShowQr(true)}
            ...
            >
                <div className={`
                    ...
                    ${isDeleting ? 'scale-95' : 'hover:-translate-y-1 hover:shadow-2xl'}
                `}>
            ...
            {showQr && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                    ...
                    <div className="
                        relative bg-gradient-to-br from-white to-gray-100
                        rounded-3xl p-10 max-w-md w-full
                        shadow-2xl
                        animate-in fade-in zoom-in duration-200
                    ">
                        <h3 className="text-3xl font-black text-black text-center mb-2">
                            Scan Ticket
                        </h3>

                        <p className="text-sm font-extrabold text-black/70 text-center mb-8">
                            Present this QR code at entry
                        </p>

                        <div className="bg-white p-6 rounded-2xl border-4 border-black/5 shadow-inner mb-8">
                            <QRCode
                                size={256}
                                style={{ height: "auto", maxWidth: "100%", width: "100%" }}
                                value={reservation.qrCode || ''}
                        ...
                        <p className="font-black font-mono text-sm text-black text-center break-all mb-6">
                            {reservation.qrCode || 'NO_QR_CODE'}
                        </p>
                        ...
                        <button
                            ...
                            className="
                                ...
                                bg-secondary text-primary-400 text-lg font-black
                                transition-all
