...
interface MapCanvasProps {
    ...
    onHoverChange: (stall: Stall | null, anchorRect: DOMRect | null) => void
}
...
function HeatmapLayer({ influences }: { influences: NormalizedInfluence[] }) {
    if (influences.length === 0) {
        console.log('HeatmapLayer: No influences to render')
        return null
    }

    console.log(`HeatmapLayer: Rendering ${influences.length} influences`, influences)
...
function ImplicitAisleLayer({ stalls }: { stalls: Stall[] }) {
