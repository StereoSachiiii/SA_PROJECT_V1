...
const CATEGORIES = ['Fiction', 'Non-Fiction', 'Children', 'Educational', 'Stationery', 'Comics', 'Manga', 'Academic'];
...
export default function VendorProfilePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const updatedUser = await vendorApi.updateProfile(formData);
        ...
        <div className="container mx-auto px-6 py-12 max-w-4xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100">
                    ...
                    <p className="text-slate-400 text-sm font-medium mb-8 pl-5">Select the genres and categories that best represent your catalog.</p>
                        ...
                        {CATEGORIES.map(cat => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest transition-all ${selected
